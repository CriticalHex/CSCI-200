...
// programs.
using namespace std;
// using std::cout; // was telling me cout was ambiguous despite no compiler
// errors;
...
void pWin() { cout << "Player wins!" << endl; }
void cWin() { cout << "Computer wins!" << endl; }
...
int main() {
  ...
  do {
    ...
    cout << "Computer choose " << getWord[computerChoice] << endl << endl;
...
char promptUser() {
  char userIn;
  cout << "Welcome one and all to a round of Rock, Paper, Scissors! (Enter P, "
          "R or S)"
       << endl;
  cout << "Player one: ";
  cin >> userIn;
